    ...
    const statusRender = currentCardProps.status?.map((status, ind) => {
        return (
            <h4 key={ind + status} className="title">
                <img src="nt-dev-landing-lorem/images/case-modal/icon-1.png" alt="icon-1"/>
                {status}
            </h4>
        )
    })
        ...
        <div className={`case-modal ${displayClass}`}>
            <div className="header">
                <button onClick={hideModalHandler}>
                    <img src="nt-dev-landing-lorem/images/case-modal/arrow-back-blue.png" alt="arrow-back-blue"/>
                </button>
            </div>
